...
STRATEGIES = {
    "short_overbought": {
        "win_rate": 0.55, "avg_win_pct": 4.5, "avg_loss_pct": 3.8,
        "leverage": 10, "weight": 0.20,
    },
    "long_oversold": {
        "win_rate": 0.52, "avg_win_pct": 5.2, "avg_loss_pct": 4.0,
        "leverage": 10, "weight": 0.15,
    },
    "prepump_sniffer": {
        "win_rate": 0.45, "avg_win_pct": 10.0, "avg_loss_pct": 5.0,
        "leverage": 10, "weight": 0.10,
    },
    "arb_cross_exchange": {
        "win_rate": 0.72, "avg_win_pct": 1.2, "avg_loss_pct": 0.8,
        "leverage": 5, "weight": 0.35,  # High weight: most reliable
    },
    "momentum_scalp": {
        "win_rate": 0.58, "avg_win_pct": 3.5, "avg_loss_pct": 2.8,
        "leverage": 10, "weight": 0.20,
    },
}
...
CONSECUTIVE_PAUSE = 1  # 1-trade cooldown
TRADES_PER_HOUR = 1.2  # Altcoin markets are fast
